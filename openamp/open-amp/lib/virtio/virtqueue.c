...
{
    PRINTF("virtqueue_disable_cb: enter\n\r");
    ...
    PRINTF("virtqueue_disable_cb: leave\n\r");
}
...
static void vq_ring_init(struct virtqueue *vq, void *ring_mem, int alignment)
{
    ...
    PRINTF("vq_ring_init: call vring_init vr=0x%x, size=%d, ring_mem=0x%x, alignment=%d\n\r", vr, size, ring_mem, alignment);
